...
function DateSelector({ settings, cabin, bookedDates }) {
    ...
    return (
        <div className="flex flex-col justify-between">
            <DayPicker
                className="px-3 pt-12 place-self-center "
                classNames={{
                    today: "text-accent-500",
                    selected: "bg-accent-500 border-accent-500 text-white ",
                    range_start: "bg-accent-500 rounded-s-3xl",
                    range_middle: "bg-accent-500",
                    range_end: "bg-accent-500 rounded-e-3xl",
                }}
                mode="range"
                onSelect={setRange}
                selected={range}
